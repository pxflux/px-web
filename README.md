<img src="static/img/pxLogo.svg" width="auto" height="20">&nbsp;&nbsp;[![Build Status](https://travis-ci.org/pxflux/px-web.svg?branch=master)](https://travis-ci.org/pxflux/px-dashboard-web)
